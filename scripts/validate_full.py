...
if __name__ == "__main__":
    ...
    # 2. 如果没有命令行参数，尝试找 model_e80.pth
        ...
        if os.path.exists(potential):
            ...
            print(f"⚠️ model_e80.pth not found in {ckpt_dir}, falling back to latest...")
            search_pattern = os.path.join(ckpt_dir, "*.pth")
    ...
    if CKPT and os.path.exists(CKPT):
        ...
        print("💡 Hint: You can manually provide a path: python validate_full.py /path/to/model.pth")